...
public partial class RailGunFire : Node2D
{
	private Timer timer;
	...
	public override void _Ready()
	{
		...
		((ParticleProcessMaterial)GetNode<GpuParticles2D>("Circle").ProcessMaterial).AngleMax = -GlobalRotationDegrees + 90; //Set("params/angle_min",Rotation);
		((ParticleProcessMaterial)GetNode<GpuParticles2D>("Circle").ProcessMaterial).AngleMin = -GlobalRotationDegrees + 90; //Set("params/angle_max",Rotation);
